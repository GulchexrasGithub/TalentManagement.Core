    ...
    public partial class UserService
    {
        private void ValidateUserOnAdd(User user)
        {
            ...
            Validate(
                ...
                (Rule: IsInvalid(user.Country), Parameter: nameof(User.Country)),
                (Rule: IsInvalid(user.PlaceOfStudy), Parameter: nameof(User.PlaceOfStudy)),
                (Rule: IsInvalid(user.DirectionOfStudy), Parameter: nameof(User.DirectionOfStudy)),
                (Rule: IsInvalid(user.Degree), Parameter: nameof(User.Degree)),
                (Rule: IsInvalid(user.UserDirection), Parameter: nameof(User.UserDirection)),
                (Rule: IsInvalid(user.UserSkills), Parameter: nameof(User.UserSkills)),
